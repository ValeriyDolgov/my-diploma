...
ALTER TABLE "projects_partners_employees" ADD FOREIGN KEY ("project_project_id") REFERENCES "projects" ("project_id");

ALTER TABLE "projects_partners_employees" ADD FOREIGN KEY ("partners_employees_id") REFERENCES "partners_employee" ("id");

ALTER TABLE "projects_project_team" ADD FOREIGN KEY ("project_project_id") REFERENCES "projects" ("project_id");

ALTER TABLE "projects_project_team" ADD FOREIGN KEY ("project_team_id") REFERENCES "employee" ("id");

ALTER TABLE "contact_person" ADD FOREIGN KEY ("company_id") REFERENCES "companies" ("company_id");
...
ALTER TABLE "companies" ADD FOREIGN KEY ("city_city_id") REFERENCES "city" ("city_id");

ALTER TABLE "companies" ADD FOREIGN KEY ("country_country_id") REFERENCES "country" ("country_id");
...
ALTER TABLE "file_data" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE "article_users" ADD FOREIGN KEY ("article_id") REFERENCES "article" ("article_id");
...
ALTER TABLE "users" ADD FOREIGN KEY ("employee_id") REFERENCES "employee" ("id");

ALTER TABLE "employee_relative" ADD FOREIGN KEY ("employee_id") REFERENCES "employee" ("id");

ALTER TABLE "employee_relative" ADD FOREIGN KEY ("relative_id") REFERENCES "relative" ("id");

ALTER TABLE "employee_address" ADD FOREIGN KEY ("employee_id") REFERENCES "employee" ("id");

ALTER TABLE "employee_address" ADD FOREIGN KEY ("address_id") REFERENCES "address" ("id");

ALTER TABLE "vacation" ADD FOREIGN KEY ("employee_id") REFERENCES "employee" ("id");

ALTER TABLE "vacation" ADD FOREIGN KEY ("replacement_user_id") REFERENCES "users" ("id");
...
ALTER TABLE "departments" ADD FOREIGN KEY ("head_of_department_id") REFERENCES "users" ("id");

ALTER TABLE "user_department" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE "user_department" ADD FOREIGN KEY ("department_id") REFERENCES "departments" ("id");
